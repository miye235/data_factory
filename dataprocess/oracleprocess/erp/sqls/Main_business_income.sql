SELECT  TO_CHAR(o288402.TRX_DATE,'YYYYMM') as TRX_DATE_CN,o288402.CUSTOMER_NAME as CUSTOMER_NAME_CN,o288402.TRX_DATE as TRX_DATE,o288402.TRX_NUMBER as TRX_NUMBER,o288402.SALES_ORDER as SALES_ORDER,o288402.DOC_SEQUENCE_VALUE as DOC_SEQUENCE_VALUE, SUBSTR(o288402.SEGMENTS,INSTR(o288402.SEGMENTS,'.',4,1)+1,INSTR(o288402.SEGMENTS,'.',4,1)-1) as ACCOUNT,o289560.NAME as NAME,o288402.INVOICE_CURRENCY_CODE as INVOICE_CURRENCY_CODE,o288402.REVENUE_AMOUNT as REVENUE_AMOUNT ,o288402.EXCHANGE_RATE as EXCHANGE_RATE,o288402.EXCHANGE_RATE*o288402.REVENUE_AMOUNT as REVENUE_AMOUNT_RMB,o288402.EXTENDED_AMOUNT as EXTENDED_AMOUNT_CN,o288402.UNIT_SELLING_PRICE as UNIT_SELLING_PRICE,o288402.UOM_CODE as UOM_CODE_CN,o288402.ITEM_NO as ITEM_NO,o288402.DESCRIPTION as DESCRIPTION,SUBSTRB(o288402.DESCRIPTION,INSTR(o288402.DESCRIPTION,';',1,2)+1,INSTR(o288402.DESCRIPTION,';',2,3)-INSTR(o288402.DESCRIPTION,';',1,2)-1) as DESCRIPTION_CN,NVL(o288402.QUANTITY_CREDITED,0)+NVL(o288402.QUANTITY_INVOICED,0) as QUANTITY_INVOICED_CN,NVL(( o288402.UNIT_LENGTH*o288402.UNIT_WIDTH )/1000000*( NVL(o288402.QUANTITY_CREDITED,0)+NVL(o288402.QUANTITY_INVOICED,0) ),0) as QUANTITY_CREDITED_CN
