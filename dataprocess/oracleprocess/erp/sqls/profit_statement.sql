select SUM(CASE WHEN A.segment3 between '5110' and '5230' THEN B.accounted_dr ELSE 0 END)-SUM(CASE WHEN A.segment3 between '5110' and '5230' THEN B.accounted_cr ELSE 0 END) 营业收入
			...
			,0 - SUM(CASE WHEN A.segment3 = '5521' and A.segment4 = '140' THEN B.accounted_dr ELSE 0 END)-SUM(CASE WHEN A.segment3 = '5521' and A.segment4 = '140' THEN B.accounted_cr ELSE 0 END) 销售费用5
			...
			,SUM(CASE WHEN A.segment3 = '7690' THEN B.accounted_dr ELSE 0 END)-SUM(CASE WHEN A.segment3 = '7690' THEN B.accounted_cr ELSE 0 END) 营业外支出3
