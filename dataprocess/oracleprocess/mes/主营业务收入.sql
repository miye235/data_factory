SELECT
o288402.CUSTOMER_NAME as 客商名称
,regexp_substr(o288402.DESCRIPTION,'\d+?\.?\d+?["|m]+',1) as 商品名称
-- ,o288402.TRX_DATE as TRX_DATE
-- ,o288402.TRX_NUMBER as TRX_NUMBER
-- ,o288402.SALES_ORDER as SALES_ORDER
-- ,o288402.DOC_SEQUENCE_VALUE as DOC_SEQUENCE_VALUE
-- , SUBSTR(o288402.SEGMENTS,INSTR(o288402.SEGMENTS,'.',4,1)+1,INSTR(o288402.SEGMENTS,'.',4,1)-1) as ACCOUNT
-- ,o289560.NAME as NAME
-- ,o288402.INVOICE_CURRENCY_CODE as INVOICE_CURRENCY_CODE
-- ,o288402.REVENUE_AMOUNT as REVENUE_AMOUNT
-- ,o288402.EXCHANGE_RATE as EXCHANGE_RATE
-- ,o288402.EXCHANGE_RATE*o288402.REVENUE_AMOUNT as REVENUE_AMOUNT_RMB

--,o288402.UNIT_SELLING_PRICE as UNIT_SELLING_PRICE
,o288402.UOM_CODE as 计量单位
--,o288402.ITEM_NO as ITEM_NO
--,o288402.DESCRIPTION as DESCRIPTION
-- ,regexp_substr(o288402.DESCRIPTION,'\d+?\.?\d+?"',1)
-- ,SUM(NVL(o288402.QUANTITY_CREDITED,0)+NVL(o288402.QUANTITY_INVOICED,0)) as 出货数量
,sum((case when o289560.NAME not like '一般折讓%' then NVL(o288402.QUANTITY_CREDITED,0) end)+(case when o289560.NAME not like '一般折讓%' then NVL(o288402.QUANTITY_INVOICED,0) end)) as 出货数量
,SUM(o288402.EXTENDED_AMOUNT) as 金额
--,NVL(( o288402.UNIT_LENGTH*o288402.UNIT_WIDTH )/1000000*( NVL(o288402.QUANTITY_CREDITED,0)+NVL(o288402.QUANTITY_INVOICED,0) ),0) as 面积
...
where org_id = '81'
 ...
 WHERE o288402.CUST_TRX_TYPE_ID = o289560.CUST_TRX_TYPE_ID
   AND TO_CHAR(o288402.TRX_DATE,'YYYY-MM')= 'thismonth'
   AND o288402.LINE_TYPE <> 'TAX'
   AND o288402.CUSTOMER_NAME <> 'CHIMEI Materials Technology Corporation'
       and o288402.CUSTOMER_NAME <> '昆山之奇美材料贸易有限公司'
 GROUP BY o288402.CUSTOMER_NAME,o288402.UOM_CODE,regexp_substr(o288402.DESCRIPTION,'\d+?\.?\d+?["|m]+',1)
 order BY o288402.CUSTOMER_NAME
