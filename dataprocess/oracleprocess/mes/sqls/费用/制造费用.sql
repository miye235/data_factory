...
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='旅費' then amount_RMB else 0 end) 旅費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='運費' then amount_RMB else 0 end) 運費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='郵電費' then amount_RMB else 0 end) 郵電費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='修繕費' then amount_RMB else 0 end) 修繕費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='廣告費' then amount_RMB else 0 end) 廣告費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='動力費' then amount_RMB else 0 end) 動力費 ,
...
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='訓練費' then amount_RMB else 0 end) 訓練費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='保全費' then amount_RMB else 0 end) 保全費,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='出口費用' then amount_RMB else 0 end) 出口費用,
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='加工費' then amount_RMB else 0 end) 加工費,
...
sum(case when Expense_Attr_Desc='制造费用' and Main_Acct_Desc='進口費用' then amount_RMB else 0 end) 進口費用,
