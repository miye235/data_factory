...
class Fee(object):
    ...
    def __call__(self,conns):
        ...
        for k,v in tables.items():
            ...
            if k=='sale_fee1':
                res.columns=['日期','工资','福利','保险费_人事','住房公积金','工会经费','职工教育经费','股份支付','职工薪酬其他','文具用品','旅费','运费','邮电费','修缮费','广告费','动力费','交际费','折旧','各项摊提','权力费','职工福利','研究发展费','训练费','保全费','出口费用','加工费','包装费','间接材料','检测费','保险费资产','什项购置','书报杂志','劳务费','进口费用','会议费','租金支出','残保金','外包人力派遣','交通费','其他费用']
            if k=='manage_fee1':
